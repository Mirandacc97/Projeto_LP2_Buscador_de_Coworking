...
public class Protocol implements Serializable{
    ...
    private String nomeNalista; //nameReserved
    ...
    private Set<String> setOn = new HashSet<String>(); //setOnlines//interface Set e sua implementação HashSet
    /*O Hashset é mais rápido e essa é uma lista simples, não possui ordem e o
    tempo de execução é o mesmo. */
    private Status status;
    
    public enum Status { 
        CONECTADO, DESCONECTADO, MSG_ENV /*SENDO_ALL*/, MSG_PRIVADA/*SEND_ONE*/, CLIENTES_ON, PROFISSIONAIS_ON
